    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function calculateTotal() {
            ...
            const price = selectedOption && selectedOption.getAttribute('data-price') 
                        ...
                        : 0;
            const quantity = parseInt(quantityInput.value) || 1; // Default ke 1 agar total harga tidak kosong
        ...
        // **Pastikan harga awal bukan NaN saat halaman pertama kali dimuat**
        calculateTotal();
    });
</script>
@endsection